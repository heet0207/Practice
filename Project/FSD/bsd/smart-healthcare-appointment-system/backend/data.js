// data.js
// Simple in-memory "database" using JavaScript arrays.
// This is used so the project runs immediately without setting up MySQL.
// (You can later replace this with real MySQL queries using the
// database/healthcare_db.sql file included in this project.)
...
let appointments = [
  { id: 1, patientId: 3, doctorId: 1, date: "2026-07-25", time: "10:00 AM", status: "Pending" }
];
